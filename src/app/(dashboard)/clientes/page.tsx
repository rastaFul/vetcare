...
import { ClientDialog } from '@/components/features/clients/ClientDialog'
    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">{meta.total} clientes cadastrados</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-sm text-gray-500 mb-6">
            {search ? 'Tente ajustar os termos de busca.' : 'Comece cadastrando o primeiro cliente.'}
          </p>
          {!search && (
            <Button onClick={() => setDialogOpen(true)} className="gap-2">
              <Plus className="w-4 h-4" />
      ...
      <ClientDialog open={dialogOpen} onClose={() => setDialogOpen(false)} onSuccess={fetchClients} />
    </div>
  )
}
